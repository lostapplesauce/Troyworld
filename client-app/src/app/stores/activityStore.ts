...
export default class ActivityStore {
    ...
    constructor() {
        makeAutoObservable(this //action.bound binds the function to the class
            //arrow function automactially binds the two.
        )
    }
    ...
    loadActivities = async () => {
        ...
        try {
            ...
            //Looping over activities and pushing them into empty array initialized above
